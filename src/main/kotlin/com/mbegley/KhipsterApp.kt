...
import com.mbegley.config.ApplicationProperties
...
class KhipsterApp(private val env: Environment) {

    private val log = LoggerFactory.getLogger(javaClass)

    /**
     * Initializes khipster.
     *
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<KhipsterApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(KhipsterApp::class.java)
